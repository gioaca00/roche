    ...
    while True:
        ...
        if choice == "Keywords":
            ...
            if len(date_range) == 1:
                ...
                query += ' AND ("' + date_range[0] + '"[Date - Publication] : "' + date_range[1] + '"[Date - Publication])'
        elif choice == "Other":
...
def more_details(articles):
    ...
    while True:
        ...
        if 1 <= article_number <= len(articles["PubmedArticle"]):
            article_options = ["I'm done with this paper", "Full Abstract", "Authors List", "Article Date", "Journal Information"]
